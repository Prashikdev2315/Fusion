...
admin.site.register(PHCUserRoleProfile)
admin.site.register(StudentProfile)
admin.site.register(StaffProfile)
admin.site.register(PHCUserAuditLog)
admin.site.register(Appointment)
admin.site.register(Visit)
admin.site.register(PHCAppointmentAuditLog)
admin.site.register(PHCReimbursementClaim)
admin.site.register(PHCReimbursementAuditLog)